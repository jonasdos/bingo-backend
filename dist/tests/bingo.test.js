...
beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, database_1.default.bingoNumber.deleteMany()];
            case 1:
                _a.sent();
...
var server;
beforeAll(function () {
    server = app_1.default.listen(3000); // ou a porta que for
});
afterAll(function () {
    server.close();
});
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, database_1.default.bingoNumber.findUnique({
                                where: { id: body.id },
                            })];
                    case 3:
                        number = _b.sent();
